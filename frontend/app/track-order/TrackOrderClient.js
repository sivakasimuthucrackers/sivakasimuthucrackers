    ...
    <main className="min-h-screen bg-[#080808] px-4 py-10 text-white md:py-16">
      <div className="mx-auto max-w-2xl">
        ...
        <form
          ...
          className="mt-7 flex flex-col gap-3 rounded-2xl border border-white/10 bg-white/5 p-3 sm:flex-row"
        >
          <input
            value={identifier}
          ...
          <button
            type="submit"
            disabled={loading}
            className="rounded-xl bg-pink-600 px-5 py-3 text-sm font-black transition hover:bg-pink-700 disabled:cursor-not-allowed disabled:opacity-60"
          >
